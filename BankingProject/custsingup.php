...
<table width=80% border=5 cellspacing=8 cellpadding=8 align=center bgcolor=skyblue>
<tr> <td colspan=2> Signup page for customers</td> </tr>
...
<tr> <td > Retype your Password </td> <td> <input type=password name=text3> </td> </tr>
<tr> <td > Name of the customer</td> <td> <input type=text name=text4> </td> </tr>
...
<tr> <td > <a href=mainpage.php> <img src="imges/button_back.png"> </a> </td> <td> <input type=submit name=Login  style="height: 45px; width: 150px;" onclick="return validate()"> </td> </tr>
