...
<tr> <td >To Account Number </td> <td> <input type=text name=text1> </td> </tr>
<tr> <td > Amount</td> <td> <input type=text name=text2> </td> </tr>
<tr> <td > Tranfer Details  </td> <td> <input type=text name=text3> </td> </tr>

<tr> <td > <a href=custmainpage.php> <img src="imges/button_back.png"> </a> </td> <td> <input type=submit name=Login  style="height: 45px; width: 150px"> </td> </tr>
